"""Shared pytest fixtures — SQLite-async for isolation.

Each test gets a fresh in-memory DB via a per-test URL + engine reset.
"""
...
async def clean_db():
    """Use a fresh in-memory sqlite per test."""
